...
import { IssuePriority, IssueStatus, IssueType } from '../shared/constans/issues';

// and here my based color
export const color = {
  primary: '#0052cc', // Blue
...
export const font = {
  regular: 'font-family: "Belleza-Regular"; font-weight: normal;',
  medium: 'font-family: "Belleza-Regular"; font-weight: normal;',
  bold: 'font-family: "Belleza-Regular"; font-weight: normal;',
  black: 'font-family: "Belleza-Regular"; font-weight: normal;',
